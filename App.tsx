...
const initialProjects: Project[] = [
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Nasarawa Technology Park', 
    projectDescription: 'Integrated ICT hub and startup incubator to foster innovation in the region.', 
    focalPersonName: 'David Chen', 
    focalPersonPhone: '555-444-5555', 
    focalPersonEmail: 'david@nasida.gov', 
    projectStage: ProjectStage.INITIATION,
    projectLocation: ProjectLocation.KARU,
    projectSubLocation: 'New Karu Digital City',
    projectSector: 'ICT & Innovation',
    jobsToBeCreated: 500,
    investmentWorth: 120000000,
    investmentType: InvestmentType.FDI,
    requiresFollowUp: false,
    createdBy: 'system',
    lastModifiedBy: 'system',
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Tunga Sugar Refinery', 
    projectDescription: 'Comprehensive sugar cane plantation and state-of-the-art refining factory.', 
    focalPersonName: 'Grace Omali', 
    focalPersonPhone: '555-666-7777', 
    focalPersonEmail: 'grace@example.com', 
    projectStage: ProjectStage.MOVED_TO_SITE,
    projectLocation: ProjectLocation.AWE,
    projectSubLocation: 'Tunga Plains',
    projectSector: 'Agriculture',
    jobsToBeCreated: 2500,
    investmentWorth: 250000000,
    investmentType: InvestmentType.MIXED,
    requiresFollowUp: true,
    createdBy: 'system',
    lastModifiedBy: 'system',
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Lafia Modern Diagnostic Centre', 
    projectDescription: 'High-end medical facility providing advanced imaging and laboratory services.', 
    focalPersonName: 'Dr. Samuel Okafor', 
    focalPersonPhone: '555-888-9999', 
    focalPersonEmail: 'samuel@health.gov', 
    projectStage: ProjectStage.COMPLETED,
    projectLocation: ProjectLocation.LAFIA,
    projectSubLocation: 'Lafia Central',
    projectSector: 'Healthcare',
    jobsToBeCreated: 400,
    investmentWorth: 45000000,
    investmentType: InvestmentType.DDI,
    requiresFollowUp: false,
    createdBy: 'system',
    lastModifiedBy: 'system',
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Keffi Retail Plaza', 
    projectDescription: 'Modern shopping complex and cinema house serving the university community.', 
    focalPersonName: 'Amina Bello', 
    focalPersonPhone: '555-000-1111', 
    focalPersonEmail: 'amina@retail.com', 
    projectStage: ProjectStage.MOU_SIGNED,
    projectLocation: ProjectLocation.KEFFI,
    projectSubLocation: 'University Road',
    projectSector: 'Commerce',
    jobsToBeCreated: 150,
    investmentWorth: 12000000,
    investmentType: InvestmentType.DDI,
    requiresFollowUp: false,
    createdBy: 'system',
    lastModifiedBy: 'system',
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Panda Agricultural Hub', 
    projectDescription: 'Large scale mechanized farming for maize and soy with silos storage infrastructure.', 
    focalPersonName: 'John Agbo', 
    focalPersonPhone: '555-222-3333', 
    focalPersonEmail: 'john@panda.com', 
    projectStage: ProjectStage.MOVED_TO_SITE,
    projectLocation: ProjectLocation.KARU,
    projectSubLocation: 'Panda District',
    projectSector: 'Agriculture',
    jobsToBeCreated: 1200,
    investmentWorth: 80000000,
    investmentType: InvestmentType.FDI,
    requiresFollowUp: true,
    createdBy: 'system',
    lastModifiedBy: 'system',
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Uke Industrial Manufacturing Zone', 
    projectDescription: 'Designated zone for light manufacturing including FMCG and household products.', 
    focalPersonName: 'Victor Musa', 
    focalPersonPhone: '555-777-8888', 
    focalPersonEmail: 'victor@musa.net', 
    projectStage: ProjectStage.INITIATION,
    projectLocation: ProjectLocation.KARU,
    projectSubLocation: 'Uke Bypass',
    projectSector: 'Industrial',
    jobsToBeCreated: 800,
    investmentWorth: 60000000,
    investmentType: InvestmentType.MIXED,
    requiresFollowUp: false,
    createdBy: 'system',
    lastModifiedBy: 'system',
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Eggon Hills Quarry Operations', 
    projectDescription: 'Modern granite crushing and quarrying site for construction materials.', 
    focalPersonName: 'Emeka Eze', 
    focalPersonPhone: '555-333-4444', 
    focalPersonEmail: 'emeka@quarry.com', 
    projectStage: ProjectStage.COMPLETED,
    projectLocation: ProjectLocation.NASARAWA_EGGON,
    projectSubLocation: 'Eggon Hills',
    projectSector: 'Mining',
    jobsToBeCreated: 100,
    investmentWorth: 15000000,
    investmentType: InvestmentType.DDI,
    requiresFollowUp: false,
    createdBy: 'system',
    lastModifiedBy: 'system',
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Toto Marble Processing Plant', 
    projectDescription: 'Extraction and processing of high-grade marble for domestic and export markets.', 
    focalPersonName: 'Ibrahim Zakari', 
    focalPersonPhone: '555-555-6666', 
    focalPersonEmail: 'ibrahim@toto.com', 
    projectStage: ProjectStage.MOU_SIGNED,
    projectLocation: ProjectLocation.TOTO,
    projectSubLocation: 'Toto Industrial Cluster',
    projectSector: 'Mining',
    jobsToBeCreated: 300,
    investmentWorth: 22000000,
    investmentType: InvestmentType.MIXED,
    requiresFollowUp: false,
    createdBy: 'system',
    lastModifiedBy: 'system',
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Doma Dam Irrigation Phase II', 
    projectDescription: 'Expansion of irrigation channels to support year-round farming for 5000 additional hectares.', 
    focalPersonName: 'Sani Doma', 
    focalPersonPhone: '555-999-0000', 
    focalPersonEmail: 'sani@water.gov', 
    projectStage: ProjectStage.MOVED_TO_SITE,
    projectLocation: ProjectLocation.DOMA,
    projectSubLocation: 'Doma Dam Site',
    projectSector: 'Agriculture',
    jobsToBeCreated: 600,
    investmentWorth: 35000000,
    investmentType: InvestmentType.DDI,
    requiresFollowUp: true,
    createdBy: 'system',
    lastModifiedBy: 'system',
  ...
  { 
    id: crypto.randomUUID(), 
    projectName: 'Wamba Gemstone Extraction', 
    projectDescription: 'Artisanal mining formalization and mechanized extraction of precious gemstones.', 
    focalPersonName: 'Lucy Wamba', 
    focalPersonPhone: '555-121-2121', 
    focalPersonEmail: 'lucy@gems.com', 
    projectStage: ProjectStage.INITIATION,
    projectLocation: ProjectLocation.WAMBA,
    projectSubLocation: 'Wamba Forest Area',
    projectSector: 'Mining',
    jobsToBeCreated: 50,
    investmentWorth: 8000000,
    investmentType: InvestmentType.FDI,
    requiresFollowUp: false,
    createdBy: 'system',
    lastModifiedBy: 'system',
