...
/**
 * FlagIcon updated to accept an optional title prop for accessibility/tooltips.
 * This fixes a type error when used with a title attribute in ProjectTable.tsx.
 */
export const FlagIcon: React.FC<{ className?: string; title?: string }> = ({ className = "w-6 h-6", title }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
